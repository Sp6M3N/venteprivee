 ...
 *
 * @ORM\Table(name="client_delivery_address", indexes={@ORM\Index(name="client_address_id", columns={"client_address_id"})})
 * @ORM\Entity
 */
class ClientDeliveryAddress
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="client_address_id", referencedColumnName="id")
     * })
     */
